      ...
      try {
        const web3auth = new Web3Auth({
          ...
          chainConfig: {
            ...
            chainId: "0x3",
            rpcTarget: `https://ropsten.infura.io/v3/${process.env.NEXT_PUBLIC_INFURA_ID}`, // This is the mainnet RPC we have added, please pass on your own endpoint while creating an app
          },
        });
